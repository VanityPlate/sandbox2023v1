            ...
            try{
                ...
                let holdInfo = (record, line, quantity = null, shipped = null) => {
                    if(quantity != null && shipped != null) {
                        ...
                        let lineSurcharge = record.getSublistValue({sublistId: 'item', line: line, fieldId: 'custcol_line_surcharge'}) ? record.getSublistValue({sublistId: 'item', line: line, fieldId: 'custcol_line_surcharge'}) : false;
